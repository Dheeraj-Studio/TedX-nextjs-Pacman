...
(function () {
    ...
    var createRenderer = function () {
        ...
        // Get the game container and set renderer size to match
    ...
    var handleResize = function(renderer, camera) {
        var gameContainer = document.getElementById('game-container');
        var containerWidth = gameContainer.clientWidth;
        var containerHeight = gameContainer.clientHeight;
    ...
    var main = function () {
        ...
        var gameContainer = document.getElementById('game-container');
        var camera = new THREE.PerspectiveCamera(65, gameContainer.clientWidth / gameContainer.clientHeight, 0.1, 1000);
        camera.up.copy(UP);
        ...
        // Audio setup (with fallback for missing files)
        var createAudio = function(src) {
            try {
                ...
                return { play: function(){}, pause: function(){} }; // Mock audio object
            }
        };

        var chompSound = createAudio('/sounds/pacman_chomp.mp3');
        chompSound.loop = true;

var levelStartSound = createAudio('/sounds/pacman_beginning.mp3');
var deathSound = createAudio('/sounds/pacman_death.mp3');
var killSound = createAudio('/sounds/pacman_eatghost.mp3');
